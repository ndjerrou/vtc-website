            ...
            <div className='grid gap-6 lg:grid-cols-2 lg:gap-12 items-center'>
              <div className='space-y-4 bg-black/50 p-6 rounded-xl backdrop-blur-sm'>
                ...
                <p className='max-w-[600px] text-gray-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                  Voyagez en toute sérénité avec notre service de VTC premium.
                  Véhicules Mercedes et Tesla, chauffeurs professionnels, tarifs
                  transparents.
                </p>
            ...
            <div className='mx-auto grid max-w-5xl gap-6 md:grid-cols-2 mt-8'>
              <Card>
                <CardHeader className='text-center'>
                  ...
                  <CardDescription>
                    Prix fixes pour les destinations populaires depuis Paris
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className='text-center'>
                  ...
                  <CardDescription>
                    Tarifs pour mise à disposition et options supplémentaires
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-4'>
